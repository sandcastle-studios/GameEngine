...
namespace FilePackager.ViewModels
{
	public class MainViewModel : ViewModelBase
	{
        ...
        private DelegateCommand _createRSXPackagesCommand;
        ...
        public ICommand CreateRSXPackagesCommand
		{
            get { return CommandManagerHelper.CreateOnceCommand(ref _createRSXPackagesCommand, CreateRSXPackages, null, Properties.Resources.CreateRSXPackages); }
		}
        ...
        private void CreateRSXPackages()
        {
            Project.ManualPackagingInfo.CreateRSXPackages();
        }
