...
void GenericMesh::SetTexture(const std::shared_ptr<Texture> & aTexture, unsigned int aIndex)
{
...
{
	for (int i = 0; i < myTexture.size(); i++)
	{
...
std::shared_ptr<Texture> GenericMesh::GetTexture(const int aIndex)
{
